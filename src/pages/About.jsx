  ...
  return (
    ...
    >
      ...
      <section className="bg-gradient-to-b from-cyan-50 via-white to-white py-24 relative overflow-hidden">
        ...
        >
          <span className="section-label">About Boutique International</span>
          <h1 className="text-6xl lg:text-7xl font-display font-bold mt-6 mb-6 text-slate-900">
            <span className="text-cyan-gradient">Four Decades</span> of Excellence
          </h1>
          <p className="text-2xl text-slate-600 max-w-3xl mx-auto">
            From a small manufacturing unit to a global leader trusted by 150+ brands across 25+ countries
          </p>
        </motion.div>
      </section>
      ...
      <section className="bg-gradient-to-r from-cyan-bright via-cyan-dark to-cyan-bright py-24 relative overflow-hidden">
        ...
        >
          ...
          <p className="text-xl text-cyan-100 max-w-2xl mx-auto mb-12">
            Let's discuss how we can elevate your brand with our premium manufacturing solutions
          </p>
          <motion.button
            onClick={() => {}}
