  ...
  return (
    <section className="bg-white py-24 relative overflow-hidden">
      ...
      >
          ...
          >
            {CERTIFICATIONS.map((cert) => (
              ...
              >
                ...
                <h3 className="text-lg font-semibold text-slate-900 mb-1">{cert.name}</h3>
                <p className="text-sm text-cyan-bright font-medium mb-3">{cert.description}</p>
                <p className="text-sm text-slate-600 leading-relaxed">{cert.details}</p>
                <AccentBar />
              </motion.div>
            ))}
          </motion.div>
        ...
        <motion.div variants={fadeUp} className="h-1 bg-gradient-to-r from-transparent via-cyan-bright to-transparent my-20" />
