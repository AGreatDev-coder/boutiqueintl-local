...
import { CUSTOMIZATION_OPTIONS } from '../../data/capabilitiesData'
    ...
    <section className="bg-gradient-to-b from-white via-blue-50 to-white py-24 relative overflow-hidden">
      ...
      >
        ...
        <motion.div variants={itemVariants} className="text-center mb-20">
          <span className="section-label">Full Customization</span>
          <h2 className="text-5xl lg:text-6xl font-display font-bold mt-4 mb-6 text-slate-900">
            Customization <span className="text-cyan-gradient">Options</span>
          </h2>
          <p className="text-xl text-slate-600 max-w-2xl mx-auto">
            Complete flexibility to create exactly what you envision
          </p>
        </motion.div>
        ...
        >
          {CUSTOMIZATION_OPTIONS.map((option) => (
            ...
            >
              {/* Icon */}
              <motion.div className="text-6xl mb-6 group-hover:rotate-12 group-hover:scale-125 transition-transform duration-300">
                {option.icon}
              </motion.div>
